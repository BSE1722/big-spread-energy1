    ...
    <div className="w-full max-w-[290px] rounded-[2.2rem] border border-border bg-card p-2 shadow-[0_0_50px_oklch(0_0_0_/_0.6)] ring-1 ring-primary/10">
      <div className="overflow-hidden rounded-[1.7rem] bg-secondary">
        ...
        <div className="border-t border-border/60 px-4 py-4">
          ...
          <Link 
            href="/board" 
            className="mt-4 w-full rounded-md border border-border py-2.5 font-display text-xs font-bold uppercase tracking-wider text-foreground transition-colors hover:border-primary hover:text-primary">
            >
            View Full Breakdown
          </Link>
        </div>
